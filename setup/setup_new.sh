...
echo "SETUP - installing spiff..."
brew tap xoebus/homebrew-cloudfoundry
brew install spiff
spiff
echo "SETUP - Successfully installed spiff."
...
echo "SETUP - Executing gem install bundler..."
pushd ../cf-release
  ./scripts/update
  gem install bundler
popd
echo "SETUP - Successfully installed the bundler."
